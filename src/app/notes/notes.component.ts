  ...
  notes: Notes[] = [
    {
      ...
      nom: 'Youssef',
      prenom: 'BAHADDOU',
      email: 'sehrawi.hedo@marrakech.com',
      note: 13,
      class: 1,
    },
    {
    ...
    },
    {
      ...
      nom: 'Bouchaib',
      prenom: 'Rachidi',
      email: 'BouchaibRachidi@example.com',
      note: 12,
      class: 3,
    },
    {
    ...
    },
    {
      ...
      nom: 'Hamada',
      prenom: 'Ridawi',
      email: 'ridawiHamada@example.com',
      note: 13,
      class: 2,
    },
    {
  ...
  get filteredNotes(): Notes[] {
    let filteredNotes =
      this.selectedClass === ''
        ? this.notes
        : this.notes.filter(
            (note) => note.class === parseInt(this.selectedClass as string)
          );
